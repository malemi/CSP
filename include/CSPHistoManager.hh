...
#ifndef CSPHistoManager_h
#define CSPHistoManager_h 1
...
class CSPHistoMessenger;

const G4int MaxHisto = 20;
...
public:
  ...
  ~CSPHistoManager();
  static CSPHistoManager* getInstance();
  static void dispose();
...
private:
  CSPHistoManager();
  static CSPHistoManager* instance;
  G4String                 fileName[20];
  G4String                 fileType;
  G4String                 fileOption;    
  ...
  G4bool                   factoryOn;
  CSPHistoMessenger*          histoMessenger;
