...
class CSPPrimaryGeneratorAction;
class CSPHistoManager;

class CSPRunAction : public G4UserRunAction
{
public:
  CSPRunAction(CSPDetectorConstruction*, CSPPrimaryGeneratorAction*);
  ~CSPRunAction();
...
private:
  ...
  CSPDetectorConstruction*   detector;
  CSPPrimaryGeneratorAction* primary;
  CSPHistoManager*           histoManager;
};
